...
```{r}
mxFDAobject_oneImage = extract_summary_functions(mxFDAobject_oneImage,
                                extract_func = extract_univariate,
                                summary_func = Gest,
...
```{r}
plot(mxFDAobject_oneImage, y = "fundiff", what = "uni g") +
  geom_hline(yintercept = 0, color = "red", linetype = 2)
```
...
```{r}
mxFDAobject_oneImage <- run_fpca(mxFDAobject_oneImage, metric = "uni g", r = "r", value = "fundiff",
                   pve = .95)
