...
lung_df = lung_df %>%
  ...
  select(contains("id"), x, y, gender, age = age_at_diagnosis, immune, survival_days, 
         event = survival_status, pack_years, mhcII_status,
...
Gdf = extract_summary_functions(lung_df, "patient_id",
                ...
                markvar = "immune",
                mark1 = "immune",
                analysis_vars = c("gender", "age", "pack_years", "survival_days", "event",
                                   "stage", "adjuvant_therapy"))


t = run_fcm(Gdf, form = "survival_days ~ stage + adjuvant_therapy",
            event = "survival_status",
            id = "patient_id", r = "r", value = "fundiff",
            analysis_vars = c("gender", "age", "survival_days", "event", "stage",
                              "adjuvant_therapy"),
